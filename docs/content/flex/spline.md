...
- **Frame settings**  
  ...
  ![](images/spline-project-settings.png){: .frame }{: width='300px' }
...
Druk op {% include btn.html btn='Copy Embed' %} om de embed code te kopiëren.

![](images/embed-code.png){: .frame }{: width='600px' }
