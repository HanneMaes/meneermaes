...
- **Strengths** _Sterktes_
- **Weaknesses** _Zwaktes_
- **Opportunities** _Kansen_
- **Threats** _Bedreigingen_
...
Na het opstellen van de handleiding in tekstvorm, is de volgende stap het ontwikkelen van een ingesproken presentatie. Deze presentatie zal dienen als een interactief en dynamisch alternatief voor de handleiding in tekstvorm.

De handleiding in tekstvorm en de ingesproken presentatie zijn onafhankelijk van elkaar en kunnen afzonderlijk worden gebruikt. Je hebt de een niet nodig om de andere te begrijpen.

Het doel van de ingesproken presentatie is om op een visuele en auditieve manier de belangrijkste aspecten van de handleiding uit te leggen. Het biedt een extra dimensie door uitleg te combineren met demonstraties.

## Opbouw van de presentatie

De presentatie volgt dezelfde structuur als de handleiding in tekstvorm:

1. Wat het onderdeel precies inhoudt, wat je er mee kan doen en waarom het handig is te gebruiken.
2. Per onderdeel of functie een schermopname waarin je laat zien hoe het werkt en hoe je het gebruikt.
3. Eindig met een samenvatting van de belangrijkste punten.

## Technische vereisten

- Zorg voor een goede opnamekwaliteit (duidelijke audio en visueel materiaal).
